...
const Header = async () => {
  ...
  return (
    <header className="bg-background-light/95 dark:bg-background-dark/95 fixed top-[env(safe-area-inset-top)] left-0 z-50 w-full transition-colors duration-300 ease-in-out">
